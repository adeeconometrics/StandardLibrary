...
public:
  constexpr explicit SinglyList_Iterator(node_pointer ptr) noexcept
      : m_ptr(ptr) {}
  ...
  auto operator*() const noexcept -> reference { return m_ptr->data; }
...
public:
  constexpr explicit cSinglyList_Iterator(node_pointer ptr) noexcept
      : m_ptr(ptr) {}
