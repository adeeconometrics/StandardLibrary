 ...
 */
template<typename ArrayStackType>
...
public:
    ...
    [[nodiscard]] auto end() noexcept -> iterator { return iterator(m_data + m_top); }
    [[nodiscard]] auto begin() const noexcept -> const_iterator { return const_iterator(m_data); }
    [[nodiscard]] auto end() const noexcept -> const_iterator { return const_iterator(m_data + m_top); }
    [[nodiscard]] auto cbegin() const noexcept -> const_iterator { return const_iterator(m_data); }
    [[nodiscard]] auto cend() const noexcept -> const_iterator { return const_iterator(m_data + m_top); }
